...
const iconMap = computed<Record<string, string>>(() => ({
  ...
  wechat: "M5.2 3.25c-1.95 0-3.45 1.25-3.45 3.02 0 1.06.55 1.96 1.48 2.55L2.7 10.6l1.9-.72c.2.03.4.04.6.04 1.95 0 3.45-1.24 3.45-3.01 0-1.78-1.5-3.66-3.45-3.66Zm5.55 1.8c1.72 0 3.05 1.11 3.05 2.7 0 .96-.5 1.77-1.34 2.31l.44 1.53-1.72-.65c-.18.02-.35.03-.53.03-1.72 0-3.04-1.1-3.04-2.69 0-1.6 1.32-3.23 3.04-3.23Z",
  ...
  __settings__: "M8 1.35a.75.75 0 0 1 .72.53l.35 1.12c.33.09.64.22.94.39l1.08-.45a.75.75 0 0 1 .87.24l.86 1.29a.75.75 0 0 1-.08.95l-.76.91c.07.33.11.67.11 1.01s-.04.68-.11 1.01l.76.91a.75.75 0 0 1 .08.95l-.86 1.29a.75.75 0 0 1-.87.24l-1.08-.45c-.3.17-.61.3-.94.39l-.35 1.12a.75.75 0 0 1-.72.53H7a.75.75 0 0 1-.72-.53l-.35-1.12a4.2 4.2 0 0 1-.94-.39l-1.08.45a.75.75 0 0 1-.87-.24l-.86-1.29a.75.75 0 0 1 .08-.95l.76-.91A4.4 4.4 0 0 1 2.9 8c0-.34.04-.68.11-1.01l-.76-.91a.75.75 0 0 1-.08-.95l.86-1.29a.75.75 0 0 1 .87-.24l1.08.45c.3-.17.61-.3.94-.39l.35-1.12A.75.75 0 0 1 7 1.35h1Zm-.5 4.4a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Z",
}))
</script>
