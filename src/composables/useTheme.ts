...
export function useTheme() {
  ...
  const applyTheme = () => {
    ...
    if (!mediaMode) {
      ...
      d.style.setProperty("--surface-alpha", glass.toFixed(3))
      d.style.setProperty("--surface-bg", `rgba(14, 18, 24, ${Math.max(0.32, glass * 1.12)})`)
      d.style.setProperty("--shell-bg", `rgba(255, 255, 255, 0.01)`)
      d.style.setProperty("--shell-bg-soft", `rgba(255, 255, 255, ${Math.max(0.03, glass * 0.12)})`)
      d.style.setProperty("--surface-1", `rgba(255, 255, 255, ${Math.max(0.05, glass * 0.18)})`)
      d.style.setProperty("--surface-2", `rgba(255, 255, 255, ${Math.max(0.07, glass * 0.22)})`)
      d.style.setProperty("--surface-3", `rgba(255, 255, 255, ${Math.max(0.1, glass * 0.28)})`)
